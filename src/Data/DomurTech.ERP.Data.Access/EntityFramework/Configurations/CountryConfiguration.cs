...
namespace DomurTech.ERP.Data.Access.EntityFramework.Configurations
{
    ...
    internal class CountryConfiguration : EntityTypeConfiguration<Country>
    {
        ...
        public CountryConfiguration(string schema)
        {
            ...
            Property(x => x.CountryCode).IsRequired().HasColumnType("nvarchar").HasMaxLength(10).HasColumnAnnotation(IndexAnnotation.AnnotationName, new IndexAnnotation(new IndexAttribute("UK_CountryCode") { IsUnique = true }));
