...
namespace DomurTech.ERP.Data.Access.EntityFramework.Configurations
{
    ...
    internal class DistrictConfiguration : EntityTypeConfiguration<District>
    {
        ...
        public DistrictConfiguration(string schema)
        {
            ...
            Property(x => x.DistrictCode).IsRequired().HasColumnType("nvarchar").HasMaxLength(10).HasColumnAnnotation(IndexAnnotation.AnnotationName, new IndexAnnotation(new IndexAttribute("UK_DistrictCode") { IsUnique = true }));
